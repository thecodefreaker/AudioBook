  ...
  const checks = [
    {
      ...
      required: true,
      ...edgeTts,
      // edge-tts --list-voices prints a huge table; don't echo it back.
      version: edgeTts.ok ? 'installed' : undefined,
      fix: 'Install Python 3, then run:  pip install edge-tts',
      why: 'Turns your script into speech. Nothing can be generated without it.',
    },
    {
      id: 'ffmpeg',
      label: 'FFmpeg',
