...
export const DEFAULTS = {
  ...
  speakingRate: 1.0,
  // Two jobs may overlap, while the shared Groq limiter still controls the
  // actual provider pressure. Keeping this above one makes the queue useful
  // for independent books without opening an unbounded worker fan-out.
  concurrency: 2,
  /**
